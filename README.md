...
This repository contains the full details of this [AMWA Specification](https://www.amwa.tv/specifications/). For the latest version of this repository please refer to [its GitHub project](https://github.com/AMWA-TV/AS-11_X4/).
...
The list of releases is available [here](https://github.com/AMWA-TV/AS-11_X4/releases). The full Specification history is available [here](https://github.com/AMWA-TV/AS-11_X4/commits). It is best to ignore changes to `AMWA_AS_11_X4.html` when examining the history of this repository. (All the pertinent changes will be apparent in other files.)
